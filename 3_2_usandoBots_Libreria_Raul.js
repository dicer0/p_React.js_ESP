/*Esta es una libreria que hicieron los de devf*/
var rp = require('request-promise');
var request = require('request')
var facebook_service = require('./3_config')
/*Aquí mando a llamar mi archivo config*/
...
class Bot {
  ...
  sendTextMessage(recipientId, messageText, quickReplies=[], messageType = 'RESPONSE') {
    if(quickReplies.length > 0){
      ...
      /*Esto es el json que le enviamos a la API de facebook para que acomode
      mi mensaje como habiamos visto este JSON es el que me arroja el bot*/
    }
